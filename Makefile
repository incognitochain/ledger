# ****************************************************************************
#    Ledger App for Incognito Network
#    (c) 2020 Ledger SAS.
#
...
ifeq ($(TARGET_NAME),TARGET_NANOS)
    ICONNAME=icons/logo1.gif
else
    ICONNAME=icons/logo12.gif
endif
...
build_all:
	...
	do                                                                      \
		...
		mv bin/app.elf tests/elfs/incognito_$$2.elf;                  \
	done
