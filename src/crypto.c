                          ...
                          unsigned char *b)
{
    ...
    incognito_keccak_update_H(seed32, 32);
    incognito_keccak_update_H(a, 32);
    incognito_keccak_update_H(b, 32);
    incognito_keccak_final_H(h1);
...
#if INCOGNITO_IO_BUFFER_LENGTH < (9 * 32)
#error INCOGNITO_IO_BUFFER_LENGTH is too small
#endif
#endif
                                 ...
                                 unsigned char *ec_priv)
{
    ...
    incognito_derivation_to_scalar(tmp, drv_data, out_idx);
