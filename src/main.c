    ...
    BEGIN_TRY
    {
        TRY
        {
            ...
            case INS_CALC_C:
                ...
                break;
            case INS_CALC_CCA:
                handleCalculateCCA(G_io_apdu_buffer[OFFSET_P1], G_io_apdu_buffer[OFFSET_P2], G_io_apdu_buffer + OFFSET_CDATA, G_io_apdu_buffer[OFFSET_LC], flags, tx);
                break;
            case INS_CALC_R:
            ...
            case INS_COIN_PRIV:
                ...
                break;
            case INS_DECRYPT_COIN:
                handleDecryptCoin(G_io_apdu_buffer[OFFSET_P1], G_io_apdu_buffer[OFFSET_P2], G_io_apdu_buffer + OFFSET_CDATA, G_io_apdu_buffer[OFFSET_LC], flags, tx);
                break;
            case INS_SIGN_SCHN:
