...
#define GLYPH_boilerplate_logo_BPP 1
extern unsigned int const C_boilerplate_logo_colors[];
extern unsigned char const C_boilerplate_logo_bitmap[];
...
extern unsigned char const C_logo_bitmap[];
#ifdef OS_IO_SEPROXYHAL
#include "os_io_seproxyhal.h"
